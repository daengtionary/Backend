...
//        isDuplicateCheck(mapRequestDto); 실제 서비스 시작시에 실행
    ...
    public ResponseEntity<?> getAllMapByCategory(String category, String address, String sort, String direction, int pageNum, int pageSize) {
        String title, content, nick;
        title = "";
        content = "";
        nick = "";

        List<MapResponseDto> mapResponseDtoPage = postRepositorySupport.findAllByMap(category, title, content, nick, address, sort, direction, pageNum, pageSize);
        return responseBodyDto.success(mapResponseDtoPage, "조회 성공");

    }

    @Transactional(readOnly = true)
    public ResponseEntity<?> getSearchMap(String category, String title, String content, String nick, String address, String sort, String direction, int pageNum, int pageSize) {
        List<MapResponseDto> mapResponseDtoPage = postRepositorySupport.findAllByMap(category, title, content, nick, address, sort, direction, pageNum, pageSize);
        return responseBodyDto.success(mapResponseDtoPage, "조회 성공");
    }
